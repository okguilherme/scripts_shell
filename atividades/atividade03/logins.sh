...
grep -v 'sshd.*' /mnt/sda3_dados/#/UFC/repository/scripts_shell/atividades/atividade03/auth.log
...
grep 'sshd.*: Accepted .* for j' /mnt/sda3_dados/#/UFC/repository/scripts_shell/atividades/atividade03/auth.log

echo -e "\n_________________________________________________________________________________________\n
3. Comando grep que encontre todas as vezes que alguém tentou fazer login via root através do sshd.\n"
read -p "Pressione Enter para continuar..."

grep 'sshd.* root' /mnt/sda3_dados/#/UFC/repository/scripts_shell/atividades/atividade03/auth.log

echo -e "\n_________________________________________________________________________________________\n
4. Comando grep que encontre todas as vezes que alguém conseguiu fazer login com sucesso no dia 29 de Setembro.\n"
read -p "Pressione Enter para continuar..."

grep '09-29.* Accepted' /mnt/sda3_dados/#/UFC/repository/scripts_shell/atividades/atividade03/auth.log
