# Ação Principal
{
    # Armazenamento em Vetor: usa $1 (IP) como chave e $2 (Latência) como valor.
    # O AWK usa o ESPAÇO como separador padrão, então não é necessário usar -F.
    latencias[$1] = $2
}

# Processamento Final (END)
END {
    # Ordenação com Pipe: Redireciona a saída (print) para o comando 'sort -k2n'.
